...
interface VegetableTableProps {
  ...
  onRemoveVegetable: (index: number) => void;
  onAddVegetable: () => void;
  onReset: () => void;
}
              ...
              >
                <td className="py-2 px-2">
                  <TableInput
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      onUpdateVegetable(index, 'name', e.target.value)
                    }
                    darkMode={darkMode}
                    required
                  />
                ...
                <td className="py-2 px-2">
                  <TableInput
                    ...
                    value={veg.growTime}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      onUpdateVegetable(index, 'growTime', e.target.value)
                    }
                    darkMode={darkMode}
                    min="1"
                  />
                ...
                <td className="py-2 px-2">
                  <TableInput
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      onUpdateVegetable(index, 'amountNeeded', e.target.value)
                    }
                    darkMode={darkMode}
                    min="1"
                  />
                ...
                <td className="py-2 px-2">
                  <TableInput
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      onUpdateVegetable(index, 'potionName', e.target.value)
                    }
                    darkMode={darkMode}
                    required
                  />
                ...
                <td className="py-2 px-2">
                  <TableInput
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      onUpdateVegetable(index, 'potionPrice', e.target.value)
                    }
                    darkMode={darkMode}
                    min="1"
                  />
