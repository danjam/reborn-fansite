...
const LayoutContent = memo(() => {
  ...
  return (
    <div className={clsx('min-h-screen flex flex-col', theme.surface.base)}>
      {/* Header */}
      <header className={clsx(theme.surface.elevated, 'shadow-sm border-b', theme.border.default)}>
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              >
                ...
                />
                {/* Site Title */}
                <span className={clsx('text-xl md:text-2xl font-bold', theme.text.accent)}>
                  Reborn Fansite
                </span>
              </Link>
            </div>
      ...
      <footer className={clsx('mt-8 py-8', theme.surface.elevated, theme.border.subtle, 'border-t')}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-center md:text-left">
              <p className={clsx('text-xs', theme.text.muted, 'opacity-75')}>
                 Made with &hearts; for the community. v{import.meta.env.VITE_REACT_APP_VERSION}
              </p>
              <p className={clsx('text-xs', theme.text.muted, 'opacity-75')}>
